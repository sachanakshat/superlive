...
function decodeId3ImageFrame(frame) {
    ...
    const mimeType = (0, utils_js_1.utf8ArrayToStr)((0, utf8_js_1.toUint8)(frame.data, 1, mimeTypeEndIndex));
    ...
    const description = (0, utils_js_1.utf8ArrayToStr)((0, utf8_js_1.toUint8)(frame.data, 3 + mimeTypeEndIndex, descriptionEndIndex));
    let data;
    if (mimeType === '-->') {
        data = (0, utils_js_1.utf8ArrayToStr)((0, utf8_js_1.toUint8)(frame.data, 4 + mimeTypeEndIndex + descriptionEndIndex));
    }
    else {
